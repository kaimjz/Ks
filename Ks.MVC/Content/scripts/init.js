...
function SmoothlyMenu() {
    $("body").hasClass("mini-navbar") ? $("body").hasClass("fixed-sidebar") ?
        ($("#sideMenu").hide(), setTimeout(function () {
            $("#sideMenu").fadeIn(500),
                //适配样式改变
                $(".nav-logo").height(30),
...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        $(window).scrollTop() > 0 && !$("body").hasClass("fixed-nav")
            ? $("#right-sidebar").addClass("sidebar-top") : $("#right-sidebar").removeClass("sidebar-top")
    });
...
$(window).on("load resize", function () {
    $(this).width() < 1025 && ($("body").addClass("mini-navbar"),
        $(".nav-logo img").attr("height", "25"),
        $(".navbar-static-side").fadeIn())
    $(this).width() > 1025 && ($("body").removeClass("mini-navbar"),
        $(".nav-logo img").attr("height", "53"))
});