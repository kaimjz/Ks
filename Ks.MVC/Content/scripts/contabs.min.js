$(function () {
    ...
    function c() {
        ...
        //                if ($(this).data("id") == o) {
        //                    var t = $(this);//, s = t.attr("src");
        //                    //t.attr("src", "").attr("src", s);
        //                    //t.show().siblings(".J_iframe").hide();
        //                    t.siblings(".J_iframe").hide();
        //                    return false
        //                }
        //            })
        //        }
        ...
        //    }
        //});
        var jtab = $(".J_menuTab[data-id='" + o + "']")
        jtab && jtab.length > 0 && (k = false, !jtab.hasClass("active") && (jtab.addClass("active").siblings(".J_menuTab").removeClass("active"), g(jtab)));
        var jiframe = $(".J_mainContent .J_iframe[data-id='" + o + "']")
        jiframe && jtab.length > 0 && jiframe.remove();
        ...
        $(".J_mainContent").find("iframe.J_iframe").hide().end().append(n);
        //$(".J_mainContent .J_iframe[data-id='" + o + "']").load("index.html #testIframe", function () {
        //    $(this).attr("src", o);
        //})
        return false
    }
